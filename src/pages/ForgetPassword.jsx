import TitleText from "../components/specSection/TitleText.jsx";
import DataForm from "../components/specSection/DataForm.jsx";
...
function ForgetPassword() {
    ...
    return (
        <div className="h-dvh flex-col items-center mt-[4rem] min-h-[50vh] font-notoTC text-center">
