...
import MerchantOrderSidebarButton from "./MerchantOrderSidebarButton";
...
const MerchantOrderSidebar = ({ merchantName }) => {
...
MerchantOrderSidebar.propTypes = {
    merchantName: PropTypes.string,
};

export default MerchantOrderSidebar;
