...
const MerchantDishEditOptions = ({ group, onDeleteGroup }) => {
            ...
            <div className="flex justify-between items-center mb-4">
                {isEditingGroupName ? (
                    <input
                        ...
                        onKeyDown={(e) =>
                            e.key === "Enter" && setIsEditingGroupName(false)
                        }
...
MerchantDishEditOptions.propTypes = {
...
export default MerchantDishEditOptions;
