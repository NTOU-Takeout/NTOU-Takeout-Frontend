...
const getStatusColors = (status) => {
    switch (status) {
      case 'PROCESSING':
        return { bgColor: 'bg-blue-500', textColor: 'text-gray-100', statusText: '製作中' };
      case 'COMPLETED':
        return { bgColor: 'bg-yellow-500', textColor: 'text-gray-100', statusText: '未取餐' };
      case 'PICKED_UP':
        return { bgColor: 'bg-green-500', textColor: 'text-gray-100', statusText: '已取餐' };
      case 'CANCELED':
        return { bgColor: 'bg-gray-300', textColor: 'text-gray-100', statusText: '取消' };
      default:
        return { bgColor: 'bg-gray-200', textColor: 'text-gray-100', statusText: '' };
    }
  };
